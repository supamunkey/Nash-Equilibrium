...
public class GridPaneController {
     ...
     *                                      function.
     *
     * @param labelStrategiesOnGameBoard    The label that will be used to contain
     *                                      each players strategies.
     *
     * @param game                          The Game the will be used to retrieve
     *                                      game information such as boardSize and player
     *                                      info.
     */
    public static void guiController(Stage primaryStage, Button getNashButton, Label labelStrategiesOnGameBoard, NashGame game){
